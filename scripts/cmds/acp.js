...
module.exports = {
  ...
  onReply: async function ({ message, Reply, event, api, commandName }) {
    ...
    if (args[0] === "add") {
      ...
      return api.sendMessage("Please select <add | del> <target number | or event.threadID, event.messageID>", event.threadID);
    }
  ...
  onStart: async function ({ event, api, commandName }) {
    ...
    api.sendMessage(`${msg}\nReply to this message with content: <add | del> <target number | or event.threadID, event.messageID>`, event.threadID, (e, info) => {
